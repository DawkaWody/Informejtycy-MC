...
public class CustomPlacedFeatures {
	public static final RegistryKey<PlacedFeature> SILVER_WOLF_ORE_PLACED_KEY = registerKey("silver_wolf_ore_placed");
	...
	public static void bootstrap(Registerable<PlacedFeature> context) {
		...
		register(context, SILVER_WOLF_ORE_PLACED_KEY, configuredFeatures.getOrThrow(CustomConfiguredFeatures.SILVER_WOLF_ORE_KEY),
				PlacementModifiers.modifiersWithCount(5, HeightRangePlacementModifier.uniform(YOffset.fixed(10), YOffset.fixed(40))));
	}

	public static RegistryKey<PlacedFeature> registerKey(String name) {
		return RegistryKey.of(RegistryKeys.PLACED_FEATURE, InformejtycyRegistry.id(name));
	}
