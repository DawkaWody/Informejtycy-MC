...
public class RecyclerBlock extends BlockWithEntity implements BlockEntityProvider {
    public static final VoxelShape SHAPE = Block.createCuboidShape(2, 0, 2, 14, 24, 14);
    public static final MapCodec<RecyclerBlock> CODEC = RecyclerBlock.createCodec(RecyclerBlock::new);
    ...
    public @Nullable <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        ...
        return validateTicker(type, CustomBlockEntities.RECYCLER_BLOCK_ENTITY_TYPE,
    ...
    public @Nullable BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return CustomBlockEntities.RECYCLER_BLOCK_ENTITY_TYPE.instantiate(pos, state);
    }
